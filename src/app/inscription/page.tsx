...
export default async function Page() {
  ...
  const copy = localized(locale, {
    fr: { eyebrow: "BÊTA PRIVÉE", title: "L’accès se fait sur invitation.", text: "Chaque application, domaine et cas d’usage transactionnel est revu par Yodev avant l’envoi du premier message.", apply: "Candidater à la bêta", invited: "J’ai déjà une invitation", subject: "Candidature Yodev Mail" },
    en: { eyebrow: "PRIVATE BETA", title: "Access is invitation-only.", text: "Every application, domain, and transactional use case is reviewed by Yodev before the first message is sent.", apply: "Apply for the beta", invited: "I already have an invitation", subject: "Yodev Mail application" },
  });
  return (
