...
export default async function Home() {
  ...
  const copy = localized(locale, {
    fr: {
      ...
      included: ["Validation manuelle avant clé live", "Accompagnement DNS inclus", "Pièces jointes contrôlées et temporaires"],
    ...
    en: {
      ...
      included: ["Manual approval before a live key", "DNS assistance included", "Controlled, temporary attachments"],
