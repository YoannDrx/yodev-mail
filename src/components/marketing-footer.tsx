...
export async function MarketingFooter() {
  ...
  return <footer className="border-t bg-card"><div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 md:grid-cols-[1fr_2fr]">
    <div><BrandMark/><div className="mt-5"><ProductLinks current="mail" locale={locale}/></div><p className="mt-4 max-w-xs text-sm text-muted-foreground">{copy.tagline}</p></div>
  ...
  </div><div className="border-t py-5 text-center text-xs text-muted-foreground">© 2026 Yodev Mail · {copy.beta}</div></footer>;
}
