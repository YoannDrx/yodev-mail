  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5 font-semibold tracking-tight", className)}>
      <svg viewBox="0 0 36 36" aria-hidden="true" className="size-8 shrink-0">
        <defs><linearGradient id="vigie-gradient" x1="4" y1="3" x2="32" y2="34"><stop stopColor="#7c3aed"/><stop offset="1" stopColor="#fb7185"/></linearGradient></defs>
        <rect width="36" height="36" rx="11" fill="url(#vigie-gradient)"/>
      ...
      <span>Vigie<span className="text-primary">Mail</span></span>
    </span>
  );
}
